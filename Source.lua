...
function ELVISHUBZ:AddWindow(NameScriptHub,Text,name,UICustomSize)
		...
		ELVISHUBZ.Themes.BlackgroundColor = Color3.fromRGB(1, 17, 33)
		ELVISHUBZ.Themes.BlackColor = Color3.fromRGB(9, 9, 19)
		ELVISHUBZ.Themes.HeaderColor = Color3.fromRGB(7, 7, 17)
		ELVISHUBZ.Themes.MewColor1 = Color3.fromRGB(9, 9, 19)
		ELVISHUBZ.Themes.MewColor2 = Color3.fromRGB(7, 7, 17)
		ELVISHUBZ.Themes.TraceColor = Color3.fromRGB(0, 76, 99)
		ELVISHUBZ.Themes.MainColor = Color3.fromRGB(19, 176, 243)
		ELVISHUBZ.Themes.MainColorDrop = Color3.fromRGB(3, 6, 25)
		ELVISHUBZ.Themes.SectionColor = Color3.fromRGB(0, 17, 35)
		ELVISHUBZ.Themes.StrokeColor = Color3.fromRGB(3, 35, 50)
		ELVISHUBZ.Themes.ButtonBlackgroundColor = Color3.fromRGB(2, 5, 22)
		ELVISHUBZ.Themes.SearchColor = Color3.fromRGB(0, 17, 35)
	end
...
print(Text .. " is Running")
	...
	local oldGui = game.CoreGui:FindFirstChild("ELVISHUBZ")
        if oldGui then
                oldGui:Destroy()
	end

	ScreenGui.Parent = CoreGui
	ScreenGui.Name = "ELVISHUBZ"
	...
	Frame.Active = true
	Frame.BackgroundColor3 = ELVISHUBZ.Themes.BlackgroundColor
...
if UserInputService.KeyboardEnabled and not UserInputService.TouchEnabled then
    ...
    local ELVISHUBZ = CoreGui:FindFirstChild("ELVISHUBZ")
    
    if ELVISHUBZ then
        local Frame = ELVISHUBZ:FindFirstChild("Frame")
        local AboutFrame = ELVISHUBZ:FindFirstChild("AboutFrame")
...
aboutFrame.BackgroundColor3 = ELVISHUBZ.Themes.BlackgroundColor
...
icon.ImageColor3 = ELVISHUBZ.Themes.MainColor
		
local topTitle = Instance.new("TextLabel", top)
topTitle.Text = "About ELVISHUB Z"
...
divider.BackgroundColor3 = ELVISHUBZ.Themes.StrokeColor
...
title.TextStrokeColor3 = ELVISHUBZ.Themes.MainColor
...
valueText.TextColor3 = isBlue and ELVISHUBZ.Themes.MainColor or Color3.new(255, 255, 255)  
...
local dpiSizes = {
    ["90%"] = {
        ELVISHUBZ = UDim2.new(0, 650, 0, 540),
        ABOUT = UDim2.new(0, 260, 0, 300),
        ABOUT_POS = UDim2.new(0, 840, 0, 70)
    },
    ["100%"] = {
        ELVISHUBZ = UDim2.new(0, 830, 0, 700),
...
local function updateDPI()
    ...
    -- Resize and fix position of main ELVISHUBZ.Frame
    local mainGui = CoreGui:FindFirstChild("ELVISHUBZ")
    if mainGui and mainGui:FindFirstChild("Frame") then
        local frame = mainGui.Frame
        frame.Size = sizeInfo.ELVISHUBZ
...
TextBox.BackgroundColor3 = ELVISHUBZ.Themes.SearchColor
...
Sound2.Ended:Connect(function()
	...
	Frame_2.BackgroundColor3 = ELVISHUBZ.Themes.MewColor1
	...
	Frame_3.BackgroundColor3 = ELVISHUBZ.Themes.MewColor2
	...
	HeadName.Text = NameScriptHub or "ELVISHUBZ"
	...
	outlo.BackgroundColor3 = ELVISHUBZ.Themes.TraceColor
	...
	outlo_2.BackgroundColor3 = ELVISHUBZ.Themes.TraceColor
	...
	outlo_3.BackgroundColor3 = ELVISHUBZ.Themes.TraceColor
...
stroke_4d.Color = ELVISHUBZ.Themes.StrokeColor
...
aboutFrame.Visible = false
	...
	function WindowFunctinos:AddTab(TabNameString,IconType)
		...
		local cc = ELVISHUBZ.Themes.MainColor

		if cc == Color3.fromRGB(0, 172, 247) then
			cc = ELVISHUBZ.Themes.BlackgroundColor
		end
		...
		Image.ImageColor3 = ELVISHUBZ.Themes.MainColor
		Image.ImageRectOffset = Vector2.new(205, 565)
		Image.ImageRectSize = Vector2.new(35, 35)
...
Sound2.Ended:Connect(function()
	Sound2:Destroy()
		...
		function TabFunctions:AddSection(SectionName,parentname)
			...
			Section.BackgroundColor3 = ELVISHUBZ.Themes.SectionColor
			...
			UIStroke.Color = ELVISHUBZ.Themes.StrokeColor
			...
			lay.Name = "lay"
			lay.Parent = Section
			lay.BackgroundColor3 = ELVISHUBZ.Themes.StrokeColor
			...
			table.insert(ELVISHUBZ.auto_function,update_section_size)
			...
			function sectionfunc:AddButton(ButtonName,callback)
				...
				Button.BackgroundColor3 = ELVISHUBZ.Themes.ButtonBlackgroundColor
			...
			function sectionfunc:AddToggle(ToggleName,Default,callback)
				...
				local function toggleval(val,timea)
					if val then
						...
						TweenService:Create(Icon,TweenInfo.new(timea),{Position=UDim2.new(0.75,0,0.5,0),BackgroundColor3=ELVISHUBZ.Themes.MainColor}):Play();
...
Sound2.Ended:Connect(function()
	Sound2:Destroy()
			...
			function sectionfunc:AddSlider(SliderNameString,Min,Max,Default,callback)
				...
				Box.BackgroundColor3 = ELVISHUBZ.Themes.ButtonBlackgroundColor
				...
				MoveFrame.BackgroundColor3 = ELVISHUBZ.Themes.MainColorDrop
				...
				Inline.BackgroundColor3 = ELVISHUBZ.Themes.MainColor
				...
				Cir.BackgroundColor3 = ELVISHUBZ.Themes.MainColor
			...
			function sectionfunc:AddDropdown(DropdownName,data,Default,callback)
				...
				TopBar.BackgroundColor3 = ELVISHUBZ.Themes.ButtonBlackgroundColor
				...
				UIStroke_2.Color = ELVISHUBZ.Themes.StrokeColor
...
Sound2.Ended:Connect(function()
	Sound2:Destroy()
				...
				table.insert(ELVISHUBZ.auto_function,auto_updatea)
				refresh()
...
function ELVISHUBZ:KeySystem(TitleName,LinkKey,callback)
	local Functions = {}
	...
	Frame_2.Parent = Frame
	Frame_2.BackgroundColor3 = ELVISHUBZ.Themes.BlackColor
	Frame_2.BorderColor3 = Color3.fromRGB(0, 0, 0)
	Frame_2.BorderSizePixel = 0
	...
	PasteKey.BackgroundColor3 = ELVISHUBZ.Themes.ButtonBlackgroundColor
	...
	CopyKey.BackgroundColor3 = ELVISHUBZ.Themes.ButtonBlackgroundColor
	...
	Submit.Name = "Submit"
	Submit.Parent = Frame
	Submit.BackgroundColor3 = ELVISHUBZ.Themes.ButtonBlackgroundColor
	...
	UIStroke_3.Color = ELVISHUBZ.Themes.StrokeColor
...
function ELVISHUBZ:Notification()
	local Notification_ = {
		MaxNotifications = 5
	}
	...
	function Notification_:Notify(Type,Head,Body,countdown)
		...
		Notify.BackgroundColor3 = ELVISHUBZ.Themes.SectionColor
		...
		IconImage.ImageColor3=ELVISHUBZ.Themes.MainColor
		...
		Countdown.BackgroundColor3 = ELVISHUBZ.Themes.MainColor
...
task.spawn(function()
	_G.index_ELVISHUBZ=true
	while _G.index_ELVISHUBZ do task.wait(0)
		pcall(function()
			for i,v in ipairs(ELVISHUBZ.auto_function) do task.wait()
				pcall(function()
					task.spawn(v)
				end)
			end
